import { getValidateLOANNormalStorageIncome } from "features/loan/normal/storage/income/selector";
import { useSelector } from "react-redux";
import { ValidateMessageIncome } from "views/pages/LOAN/utils/message";

const useNormalIncomeMessage = () => {

  const validate = useSelector(getValidateLOANNormalStorageIncome);
...
export default useNormalIncomeMessage;