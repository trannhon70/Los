...
export interface SelectInterestPaymentMethodProps{
  label?: ReactNode;
  required?: boolean;
  message?: string;
  value?: string;
...
const SelectInterestPaymentMethod: FC<SelectInterestPaymentMethodProps> = props => {
...
export default SelectInterestPaymentMethod;