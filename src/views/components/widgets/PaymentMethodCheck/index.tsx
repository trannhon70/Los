...
export interface PaymentMethodCheckProps{
  value?: string;
  label?: ReactNode;
...
const PaymentMethodCheck: FC<PaymentMethodCheckProps> = props => {

  const { onChange, value, label, disabled } = props;

  const { PaymentMethod , register } = useMasterData();
