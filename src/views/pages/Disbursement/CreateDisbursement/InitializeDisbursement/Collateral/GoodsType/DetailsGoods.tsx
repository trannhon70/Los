...
const DetailsGoods: FC = () => {
  ...
  const optionsData: IGroupListBase[] = [{
    value: 1,
    label: `Vật tư hàng hóa 1`,
    key: 1,
    valueMoney: 100000
  },
  {
    value: 2,
    label: `Vật tư hàng hóa 2`,
    key: 2,
    valueMoney: 200000
  },
  {
    value: 3,
    label: `Vật tư hàng hóa 3`,
    key: 3,
    valueMoney: 300000
  },
  {
    value: 4,
    label: `Vật tư hàng hóa 4`,
    key: 4,
    valueMoney: 400000
  }
  ]
  ...
  return <Fragment>
    <TableRow>
      <TableCell width={'20%'}>
        <Typography sx={SxCollatertalCommon}>Vật tư hàng hóa 1</Typography>
      </TableCell>
      <TableCell>
