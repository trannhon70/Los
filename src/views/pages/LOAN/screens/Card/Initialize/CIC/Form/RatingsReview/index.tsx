...
import ReviewDetailsInfo from '../../../CIC/Form/ReviewDetailInfo';
...
const RatingsReview: FC = () => {
  ...
  return <div className={`${classes.root} pt-5`}>
    ...
    <ReviewDetailsInfo open={isOpenModal} onClose={handleCloseModal} />
  </div>
