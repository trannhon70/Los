...
import { SxCollateralTabs } from 'views/pages/LOAN/screens/Normal/Initialize/CollateralNew/style';
import LegalInformationOwner from 'views/pages/LOAN/screens/Normal/Initialize/CollateralNew/LegalInformationOwner';
import LegalInfomationCertificate from 'views/pages/LOAN/screens/Normal/Initialize/CollateralNew/LegalInfomationCertificate';
import { useSelector } from 'react-redux';
import { getLOANormalStoreColalteralLandCTXDGcnQshData, getLOANormalStoreLandLegalItemActive } from 'features/loan/normal/storage/collateralV2/selector';
...
const CTXDGcn: FunctionComponent<ICTXDGcnProps> = (props) => { // done
