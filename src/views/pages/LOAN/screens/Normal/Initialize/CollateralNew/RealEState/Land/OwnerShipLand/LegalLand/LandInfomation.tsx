      ...
      <Grid container spacing={3} className="pl-4 pb-4">
        ...
        >
          <SelectLocation
            ...
            message={[
              getMessage('province', { position: SubTypeItemsActive,type:'LAND', pv: '' }),
              getMessage('district', { position: SubTypeItemsActive,type:'LAND', pv: '' }),
              getMessage('ward', { position: SubTypeItemsActive, type:'LAND',pv: '' }),
            ]}
        ...
        >
          <SelectLocation
            ...
            required={[true, true, true]}
            message={[
              getMessage('province', { position: SubTypeItemsActive,type:'LAND', pv: 'certificate' }),
              getMessage('district', { position: SubTypeItemsActive,type:'LAND', pv: 'certificate' }),
              getMessage('ward', { position: SubTypeItemsActive, type:'LAND',pv: 'certificate' }),
            ]}
          />
        </Grid>
        ...
        <Grid item xl={6} lg={6} md={12} sm={12} xs={12}>
          <Input
            ...
            message={getMessage('purpose_using_lane_other', { position: SubTypeItemsActive })}
          />
        </Grid>
      </Grid>
