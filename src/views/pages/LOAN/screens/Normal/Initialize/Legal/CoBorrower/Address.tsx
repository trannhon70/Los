...
export interface ICoBorrowerAddresssRef {
  validate(): boolean;
}

export interface ICoBorrowerAddressProps{}


type TCoBorrowerAddressComponent = ForwardRefRenderFunction<
  ICoBorrowerAddresssRef, 
  ICoBorrowerAddressProps
>

const CoBorrowerAddress: TCoBorrowerAddressComponent = (props, ref) => {
  ...
  const validateMessage = () => {
    ...
    const isPlaceOfIssue = dataUseList?.identity?.find(i => i.primaryFlag)?.placeOfIssue.length ?? 0;
...
export default forwardRef(CoBorrowerAddress);
