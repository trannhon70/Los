...
export interface ICoBorrowerIdentityRef{
  validate(): boolean;
}

export interface ICoBorrowerIdentityProps{}

type TCoBorrowerIdentityComponent = ForwardRefRenderFunction<
  ICoBorrowerIdentityRef,
  ICoBorrowerIdentityProps
>

const CoBorrowerIdentity: TCoBorrowerIdentityComponent = (props, ref) => {
  ...
  const onHandleChangeIdenLegal = (
     ...
     * 
     */
    // const placeOfIssueLenght = idenNewEdit?.placeOfIssue?.length ?? 0;
    if (
      ...
      if(idenPrimary){
        ...
        dispatch(addLOANNormalStorageLegalDeclareIdentity(
          [...idens, {...idenNewEdit,uuidRemote: generateUUID()}], 
          {
            declare : SCREEN, 
            uuid_persion: activePersionUuid
          }
        ...
        <Box>
          <Grid container spacing={3}>
            ...
            <Grid item xl={4} lg={6} md={12} sm={12} xs={12}>
              <InputDate
                label="2. Ngày cấp"
                value={identity?.issuedDate ?? null}
                required
          ...
          <Grid container spacing={3} className="mt-0">
            <Grid item xl={4} lg={6} md={12} sm={12} xs={12}>
              <InputDate
                ...
                value={identity?.expiredDate ?? null}
                required
...
export default forwardRef(CoBorrowerIdentity);
