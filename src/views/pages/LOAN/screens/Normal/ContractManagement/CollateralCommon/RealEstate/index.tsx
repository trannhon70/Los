...
import DescribeLandInfo from "./DescribeLandInfo";
import DescribeMarketInfo from "./DescribeMarketInfo";
    ...
    <Box>
      <Box className="flex" sx={{ paddingTop: "10px", paddingBottom: "10px" }}>
        ...
        >
          ...
          <Box component="div" width="58%" className="flex">
            <Typography variant="h6" className="text-16 flex items-center" sx={{ marginLeft: '8px' }}>
              Thông tin:
            </Typography>
...
export default CollateralRealEstate;
