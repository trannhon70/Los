                      ...
                      <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
                        ...
                        >
                          ...
                          <TabPanel padding={false} value={CurrentTab} index={1}>
                            {/* <ButtonAttachmentModalCollateral data={collateralData?.documents ?? []} /> */}
                            <ButtonDetailSubItemAttachment dataItems={dataItems} masterData={{ uuid: collateralData?.uuidActiveData ?? "", uuidActive: subType?.uuidActiveSubtype ?? "", collaretalType:'OTHE' }} viewOnly={true} />
