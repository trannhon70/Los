      ...
      <Table>
        <TableBody>
          <TableRow>
            ...
            <TableCell width={'20%'}>
              <Typography sx={SxCollatertalCommon}>Quyền tài sản</Typography>
            </TableCell>
            <TableCell>
            </TableCell>
              ...
              <Collapse unmountOnExit={true} timeout={1000} in={isOpen} sx={{
                ...
                <TableRow>
                  <TableCell width='100%' sx={{
                    ...
                    <GroupListBase labelAdd='Thêm tài sản'
                        ...
                        >
                          ...
                          <TabPanel padding={false} value={CurrentTab} index={1}>
                            <TabPanel padding={false} value={CurrentTab} index={1}>
                              ...
                              <ButtonDetailSubItemAttachment dataItems={dataItems} masterData={{ uuid: collateralData?.uuidActiveData ?? "", uuidActive: subType?.uuidActiveSubtype ?? "",collaretalType:'RPRO' }} viewOnly={true} />
