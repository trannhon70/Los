...
import { getLOANormalStoreInformationApproval } from 'features/loan/normal/storageApproval/collateral/selector';
...
const MarketInfoLegal: FunctionComponent<IMarketInfoLegalProps> = (props) => {
  ...
  const dataItems = useSelector(getLOANormalStoreInformationApproval( uuidActiveData, uuIdSubType ?? ''));
