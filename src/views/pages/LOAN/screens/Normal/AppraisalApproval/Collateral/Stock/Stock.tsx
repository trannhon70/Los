                        ...
                        >
                          ...
                          <TabPanel padding={false} value={CurrentTab} index={1}>
                            <TabPanel padding={false} value={CurrentTab} index={1}>
                              ...
                              <ButtonDetailSubItemAttachment dataItems={dataItems} masterData={{ uuid: collateralData?.uuidActiveData ?? "", uuidActive: subType?.uuidActiveSubtype ?? "", collaretalType:'STOC' }} viewOnly={true}/>
