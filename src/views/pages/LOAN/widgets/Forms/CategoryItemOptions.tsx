import { 
  ...
  const CategoryItemOptions: OptionListComponent = (props, ref) => {
    ...
    >
      {options.map((option, index) => {
        const activatedIcon = option.activatedIcon === true;
        ...
        >
          ...
          >
              ...
              <ListItemIcon sx={{ minWidth: '38px' }}>
                <Checkbox
                  ...
                  sx={{ 
                    ...
                    ml: '-2px',
                    '& svg': {
                      color: checkedBg && activatedIcon ? '#fff' : undefined,
                      transition: 'all ease 0.3s'
                    }
                  }}
                />
            ...
            {
              before ? null :
              <ListItemIcon sx={{ minWidth: '38px', justifyContent: 'flex-end' }}>
                <Checkbox
                  edge="start"
                  checked={ activatedIcon }
                  tabIndex={ -1 }
  ...
  export default forwardRef(CategoryItemOptions);